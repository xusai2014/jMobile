...
class AllHeader extends React.Component {
  ...
  render() {
    ...
    return ([<div style={{ position:'fixed',height:'0.81rem',width:'7.5rem',background: color,border:"1px solid #F1F1F1"}}>
      {
        hide ? null :
    ...
    </div>,<div style={{ height:'0.81rem',width:'7.4rem',background: color,border:"1px solid #F1F1F1"}}></div>])
  }
}
